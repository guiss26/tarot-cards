...
export default function WelcomeScreen() {
    // Verificar ANTES del primer render si ya visitó
    const hasVisited = sessionStorage.getItem('hasVisitedWelcome');
    // const [show, setShow] = useState(false);
    const [show, setShow] = useState(!hasVisited);

    // useEffect(() => {
    //     // Verificar si es la primera vez que se carga la página en esta sesión
    //     // const hasVisited = sessionStorage.getItem('hasVisitedWelcome');
    ...
    //         // Ocultar el WelcomeScreen después de 4 segundos
    ...
    useEffect(() => {
        if (!hasVisited) {
            ...
            // Ocultar el WelcomeScreen después de 3 segundos
            const timer = setTimeout(() => {
                setShow(false);
            }, 3000);
